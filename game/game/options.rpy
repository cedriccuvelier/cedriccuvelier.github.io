...
define config.name = _("En route vers la maternelle !")
...
define gui.about = _p("""
Ce programme a été réalisé en 2026 par Cédric Cuvelier dans le cadre d'un cours destiné aux étudiants de master MEEF premier degré sur le site de Valenciennes de l'INSPÉ de Lille.
""")
...
define build.name = "Enrouteverslamaternelle2026.4"
...
define config.main_menu_music = "audio/happy-music.mp3"
...
define config.save_directory = "Enrouteverslamaternelle2026-1767723082"
